...
('Escritor', 'Puede crear y editar cuestionarios y publicaciones'), 
('Lector', 'Puede realizar cuestionarios y ver publicaciones');

INSERT INTO Medals (MedalName, Description, RequiredCorrectAnswers) VALUES 
('Oro', 'Otorgado por responder correctamente todo el cuestionario', 10), 
('Plata', 'Otorgado por responder correctamente la mayoria del cuestionario', 9), 
('Bronce', 'Otorgado por responder correctamente parte el cuestionario', 8);

INSERT INTO Users (Username, LastName, FirstName, Email, Password, RegistrationDate, RoleID)
VALUES
('user1', 'Doe', 'John', 'john.doe@example.com', 'hashed_password', CURRENT_DATE, 1);

INSERT INTO Users (Username, LastName, FirstName, Email, Password, RegistrationDate, RoleID)
VALUES
('user2', 'Smith', 'Jane', 'jane.smith@example.com', 'hashed_password', CURRENT_DATE, 2);
